        ...
        return (
            <div className="media-player-body">
                ...
                <div className="media-track">
                    <p className="t-small t-medium th-f-color">{this.state.mainField3}</p>
                    <p className="t-large t-light th-f-color">{this.state.mainField1}</p>
                    <p className="t-large t-light th-f-color-secondary">{this.state.mainField2}</p>
